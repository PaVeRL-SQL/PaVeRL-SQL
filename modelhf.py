...
#reference: https://zhuanlan.zhihu.com/p/25763072556
#The code is to consolidate GRPO trained checkpoints models into huggingface format
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp', dest='exp', type=str, default='spider1')
    parser.add_argument('--step', dest='step', type=int)
    args = parser.parse_args()

    step = args.step
    expname = args.exp
    local_dir = f"./checkpoints/grpo/{expname}_omnisql7b_grpo/global_step_{step}/actor"  #initial model location
    hf_path = local_dir
    output_path = f"./grpomodels/OmniSQL7B_{expname}_step_{step}"
